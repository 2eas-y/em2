...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        if (yearCounter) {
            ...
            yearCounter.setAttribute('data-count', years);
            yearCounter.textContent = years; // Fallback
        }

        //>> Guide Popup & Download <<//
        $('.img-popup-custom').magnificPopup({
            type: 'inline',
            midClick: true
        });
        ...
        $('#guide-form').on('submit', function (e) {
            ...
            setTimeout(function () {
                ...
                link.href = 'assets/guide.pdf';
                link.download = 'guide.pdf'; // Force download
